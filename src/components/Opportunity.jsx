        ...
        <div class="container px-5 mx-auto">
          ...
          <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2 ">
            ...
            <div href="#" class=" p-6 bg-white  border-gray-200 rounded-lg mb-4 transition duration-500 ease-in-out transform shadow-md border hover:scale-105 ">
                <p class="font-semibold text-gray-700 antialiased ">We help students become better problem solver by fostering learning and professional development.</p>
            </div>
            <div href="#" class=" p-6 bg-white  border-gray-200 rounded-lg mb-4 transition duration-500 ease-in-out transform shadow-md border hover:scale-105  ">
                <p class="font-semibold text-gray-700  antialiased ">You will get the opportunity to receive training and develop communication, project development, time management and programming skills while at college.</p>
            </div>
