...
function TeamTshirt(props) {
  ...
  return (
    <>
      <form className="m-auto w-full p-4 sm:w-2/3 md:w-1/3">
        <h1 className="p-8 text-center text-2xl font-bold">
          Team T-Shirt Order
        </h1>
        <img
          src="https://drive.google.com/file/d/1-H-5dsKBjpOLGVFB_6Xth0sIq5Wi3nmj/view?usp=sharing"
          alt="tshirt pic"
        />
        <div className="mb-6">
          <label
        ...
        <div className="mb-6">
          ...
          <select className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 ">
